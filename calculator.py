...
import sys
MaterialList = {"Concrete, Cast In Situ": [0.090, 220] , "Concrete, Grade 25": [0.130, 2350], "Concrete, Grade 40": [0.170, 2400], "Concrete, Precast, Ordinary Portland Cement": [0.148, 2400],  "Concrete, General": [0.09,220], "General Clay Bricks": [0.210, 1950], "Steel, plate":[2.460, 7850], "Solventborne Paint": [3.760, 1200]}  # kgCO2e per kg, kg per m^3 (Gen 1)
...
if __name__ == "__main__":
    calculate_embodied_carbon("/Users/jk/Downloads/z. Complex Models/Complex 2b_retry.ifc")